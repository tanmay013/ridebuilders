...
const carExtrasById: Record<string, ExtraSpec> = {
  "mercedes-c63-amg": {
  ...
  "porsche-911-carrera-s": {
    ...
    kerbWeight: "1,419 kg",
    wheelbase: "2,670 mm",
    groundClearance: "106 mm",
    length: "4,543 mm",
    width: "1,930 mm",
  },
  "bmw-m2-competition": {
    engine: "4.9L Flat-12 NA",
    power: "390 HP",
    torque: "490 Nm",
    zeroToHundred: "5.2 s",
    topSpeed: "290 km/h",
