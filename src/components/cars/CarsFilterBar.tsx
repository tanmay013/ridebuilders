              ...
              <AnimatePresence>
                {openFilterId === filter.id && (filter.options?.length ?? 0) > 0 && (
                  <motion.div
                    ...
                    className="absolute left-0 right-0 top-[calc(100%+8px)] z-50 overflow-hidden rounded-xl border border-white/10 bg-black/90 p-1.5 shadow-[0_14px_38px_rgba(0,0,0,0.55)] backdrop-blur-xl"
                  >
